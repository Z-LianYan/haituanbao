      ...
      <div class="flex task-box-top">
        ...
        <div class="box-right">
          <div class="task-info">
            ...
            <span class="task-status in-progress">草稿</span>
          </div>
          ...
          <div class="flex main-between cross-center">
            ...
            <div :data-no="index" class="flex both-center tag-edit-btn" @click="onPageTaskEditPublish3(index)">编辑</div>
            <div class="flex both-center tag-edit-btn" @click="toDistributePayment(item.task_id, item.price, item.works)">发布</div>
